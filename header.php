      ...
      <div class="w-full flex max-w-[1440px] items-center justify-between gap-3 mx-auto px-4 sm:px-8 md:px-12 lg:px-[100px]">
        ...
        <div class="flex min-w-0 flex-1 items-center justify-end gap-2 md:gap-3">
          <nav class="hidden lg:block min-w-0 flex-1" id="menu">
            ...
            <li>
              <a href="<?php echo esc_url(home_url('/fanclub/login/')); ?>" class="rounded-[8px] mr-2 lg:mr-4 xl:mr-6  header_btn_login ml-3 text-[16px] border border-[#13AA05] border-solid !border-[1.5px] !text-[#13AA05] bg-white px-6 py-2 rounded-[8px] inline-block no-underline">ログイン</a>
            </li>
          </ul>
        </nav>
