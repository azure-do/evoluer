...
/**
 * Fanclub member header off-canvas menu (slide from right).
 *
 * @package evoluer
 */
...
?>
<div
	id="evoluer-offcanvas-backdrop-fanclub"
	...
	data-evoluer-offcanvas-backdrop="fanclub"
	aria-hidden="true"
	hidden></div>
<div
	id="evoluer-offcanvas-fanclub"
	...
	role="dialog"
	aria-modal="true"
	aria-labelledby="evoluer-offcanvas-fanclub-title"
	aria-hidden="true"
	tabindex="-1"
	hidden>
	<div class="flex shrink-0 items-center justify-center	 bg-white px-4 md:px-6 pt-[20px]">
		<span id="evoluer-offcanvas-fanclub-title" class=" xl:text-[120px] text-[60px] lg:text-[80px] font-bold text-[#000]">Fan Club</span>
		<button
			type="button"
			...
			data-evoluer-offcanvas-close="fanclub"
	...
	<nav class="flex-1 overflow-y-auto overscroll-contain px-[40px] py-6 md:px-[40px] xl:px-[80px] lg:py-12 xl:py-20 bg-white" aria-label="<?php echo esc_attr__('ファンクラブメニュー', 'evoluer'); ?>">
