<?php
/**
 * Single template: fcnews（ファンクラブ新着情報）
 */
?>
...
$scf_content = (string) get_post_meta( $post_id, 'fc_news_content', true );
...
<main id="container" class="bg-[#DDE4DE] pb-[20px] md:pb-[30px] xl:pb-[40px]">
	...
	<section class="w-full max-w-[1130px] mx-auto px-[30px] pt-[60px] pb-[60px]">
		<div class="relative mb-[32px] xl:mb-[60px]">
			<div class="relative mx-auto mt-6 lg:mt-8 xl:mt-12">
				<h3 class="z-10 text-[28px] lg:text-[32px] xl:text-[34px] font-bold text-[#FBFEA3] text-center" style="-webkit-text-stroke: 1px #096B00;">
					News
				</h3>
			</div>
		</div>
