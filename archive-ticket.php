			...
			<?php if ( have_posts() ) : ?>
				<div class="bg-transparent overflow-hidden mt-[30px]">
					...
					while ( have_posts() ) :
						the_post();
						?>
						<a href="<?php echo esc_url( get_permalink() ); ?>" class="group block border-b border-[#ffffff5c] px-[4px] md:px-[8px] xl:px-[22px] py-[12px] md:pt-[18px] md:pb-[20px] transition-colors hover:bg-white/10">
